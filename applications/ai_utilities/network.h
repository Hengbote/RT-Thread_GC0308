...
#define AI_NETWORK_IN_1_HEIGHT      (224)       //AI网络输入高度
#define AI_NETWORK_IN_1_WIDTH       (224)       //AI网络输入宽度
#define AI_NETWORK_IN_1_CHANNEL     (1)         //AI网络输入颜色通道数
#define AI_NETWORK_IN_1_SIZE        (AI_NETWORK_IN_1_HEIGHT * AI_NETWORK_IN_1_WIDTH * AI_NETWORK_IN_1_CHANNEL)
#define AI_NETWORK_IN_1_SIZE_BYTES  (AI_NETWORK_IN_1_SIZE * 4)    //AI网络的输入大小字节 ?
//#define AI_NETWORK_IN_1_HEIGHT      (224)       //AI网络输入高度
//#define AI_NETWORK_IN_1_WIDTH       (224)       //AI网络输入宽度
//#define AI_NETWORK_IN_1_CHANNEL     (3)
//#define AI_NETWORK_IN_1_SIZE        (224 * 224 * 3)
//#define AI_NETWORK_IN_1_SIZE_BYTES  (602112)    //AI网络的输入大小字节
