...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 40, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (40)       //AI网络激活数据大小(单位字节) 这通常与神经网络的结构（即网络的层数和每层的神经元数量）有关
//#define AI_NETWORK_DATA_ACTIVATIONS_SIZES
//  { 403232, }
//#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (403232)       //AI网络激活数据大小(单位字节) 这通常与神经网络的结构（即网络的层数和每层的神经元数量）有关
